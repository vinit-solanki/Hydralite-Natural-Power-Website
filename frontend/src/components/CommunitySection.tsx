        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-end gap-4 mt-4">
              <span className="text-xs tracking-widest font-medium text-foreground">
                FOLLOW US
              </span>
              <div className="flex gap-2">
                <a href="#" className="w-8 h-8 flex items-center justify-center bg-primary text-primary-foreground hover:bg-accent transition-colors">
